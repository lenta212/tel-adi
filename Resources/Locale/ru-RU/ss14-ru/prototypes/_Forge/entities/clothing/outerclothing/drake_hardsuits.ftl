ent-ClothingOuterHardsuitDrakeMk4 = промышленный скафандр Drake MK4
    .desc = Базовый промышленный скафандр Drake Industries для работы в вакууме. В перчатках развёртываются голографический пистолет и крюк-кошка. Крепление бронепластин не предусмотрено.
    .suffix = Drake
